...
function ListeMpiangonaDrag() {
    ...
    const titleTable = [
        ...
        { title: "ANARANA", data: "nommpiangona", typeData: 'input', isExtra: true },
        { title: "FANAMPINY 1", data: "prenommpiangona", typeData: 'input', isExtra: true },
        {
        ...
        { title: "N° KARATRA MPANDRAY", data: "karatrampandray", typeData: 'input', isExtra: true },
